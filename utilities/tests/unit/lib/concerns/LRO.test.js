...
const {concern, contextForConcern} = require("../../../helpers/concerns");
const {removeElvEnvVars} = require("../../../helpers/params");

removeElvEnvVars();

const LRO = concern("LRO");
const context = contextForConcern(LRO);
...
describe("LRO.statusMapProcess()", () => {
  ...
  it(`should set run_state to ${LRO.STATE_BAD_PCT} if finished but progress < 100%`, () => {
    ...
    const revisedMap = context.concerns.LRO.statusMapProcess(statusMap);
