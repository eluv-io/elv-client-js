...
class FrameClient {
  ...
  AllowedMethods() {
    return [
      ...
      "AddContentObjectGroups",
      "AddContentObjectQueryFields",
      "AddContentObjectTags",
      ...
      "RemoveContentObjectGroups",
      "RemoveContentObjectQueryFields",
      "RemoveContentObjectTags",
      ...
      "SetContentObjectGroups",
      "SetContentObjectImage",
      "SetContentObjectQueryFields",
      "SetContentObjectTags",
