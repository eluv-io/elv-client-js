...
function () {
  ...
  _createClass(AuthorizationClient, [{
    ...
    value: function AccessType(id) {
      var contractName;
      return regeneratorRuntime.async(function AccessType$(_context9) {
        while (1) {
    ...
    key: "AccessComplete",
    value: function AccessComplete(_ref12) {
      var id, abi, score, address, requestId, event;
      return regeneratorRuntime.async(function AccessComplete$(_context10) {
        while (1) {
    ...
    key: "GetAccessCharge",
    value: function GetAccessCharge(_ref13) {
      var objectId, args, info;
      return regeneratorRuntime.async(function GetAccessCharge$(_context11) {
        while (1) {
    ...
    key: "Owner",
    value: function Owner(_ref14) {
      var id, abi, ownerAddress;
      return regeneratorRuntime.async(function Owner$(_context12) {
        while (1) {
    ...
    value: function Sign(message) {
      return regeneratorRuntime.async(function Sign$(_context13) {
        while (1) {
    ...
    key: "KMSAddress",
    value: function KMSAddress(_ref15) {
      var objectId, versionHash;
      return regeneratorRuntime.async(function KMSAddress$(_context14) {
        while (1) {
    ...
    key: "KMSInfo",
    value: function KMSInfo(_ref16) {
      var objectId, versionHash, KMSInfo, publicKey;
      return regeneratorRuntime.async(function KMSInfo$(_context15) {
        while (1) {
    ...
    key: "MakeKMSCall",
    value: function MakeKMSCall(_ref18) {
      var objectId, versionHash, methodName, params, KMSUrls, i, stateChannelProvider;
      return regeneratorRuntime.async(function MakeKMSCall$(_context17) {
        while (1) {
    ...
    value: function ReEncryptionConk(_ref19) {
      var libraryId, objectId, versionHash, cap;
      return regeneratorRuntime.async(function ReEncryptionConk$(_context18) {
        while (1) {
    ...
    value: function RecordTags(_ref20) {
      ...
      return regeneratorRuntime.async(function RecordTags$(_context19) {
        while (1) {
    ...
    value: function CreateAccessGroup() {
      ...
      return regeneratorRuntime.async(function CreateAccessGroup$(_context20) {
        while (1) {
    ...
    value: function CreateContentType() {
      ...
      return regeneratorRuntime.async(function CreateContentType$(_context21) {
        while (1) {
    ...
    value: function CreateContentLibrary(_ref23) {
      var kmsId, _ref24, contractAddress, transactionHash;

      return regeneratorRuntime.async(function CreateContentLibrary$(_context22) {
        while (1) {
    ...
    value: function CreateContentObject(_ref25) {
      var libraryId, typeId, _ref26, contractAddress, transactionHash, objectId;

      return regeneratorRuntime.async(function CreateContentObject$(_context23) {
        while (1) {
