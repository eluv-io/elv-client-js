  ...
  _createClass(ElvClient, [{
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee42(_ref47) {
        var libraryId, objectId, writeToken, region, bucket, filePaths, accessKey, secret, _ref47$copy, copy, callback, defaults, ops, _ref48, id, status, done, progress, _progress;
        ...
        return regeneratorRuntime.wrap(function _callee47$(_context47) {
          while (1) {
            switch (_context47.prev = _context47.next) {
              case 0:
                libraryId = _ref54.libraryId, objectId = _ref54.objectId, writeToken = _ref54.writeToken, uploadId = _ref54.uploadId;
        ...
        return regeneratorRuntime.wrap(function _callee48$(_context48) {
          while (1) {
            switch (_context48.prev = _context48.next) {
              case 0:
                libraryId = _ref55.libraryId, objectId = _ref55.objectId, writeToken = _ref55.writeToken, uploadId = _ref55.uploadId, jobId = _ref55.jobId;
        ...
        return regeneratorRuntime.wrap(function _callee49$(_context49) {
          while (1) {
            switch (_context49.prev = _context49.next) {
              case 0:
                libraryId = _ref56.libraryId, objectId = _ref56.objectId, writeToken = _ref56.writeToken, uploadId = _ref56.uploadId, jobId = _ref56.jobId, fileData = _ref56.fileData;
        ...
        return regeneratorRuntime.wrap(function _callee51$(_context51) {
          while (1) {
            switch (_context51.prev = _context51.next) {
              case 0:
                libraryId = _ref58.libraryId, objectId = _ref58.objectId, writeToken = _ref58.writeToken, filePaths = _ref58.filePaths;
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee52(_ref59) {
        var libraryId, objectId, versionHash, filePath, _ref59$format, format, path;

        return regeneratorRuntime.wrap(function _callee52$(_context52) {
          while (1) {
            switch (_context52.prev = _context52.next) {
              case 0:
                libraryId = _ref59.libraryId, objectId = _ref59.objectId, versionHash = _ref59.versionHash, filePath = _ref59.filePath, _ref59$format = _ref59.format, format = _ref59$format === void 0 ? "arrayBuffer" : _ref59$format;
        ...
        return regeneratorRuntime.wrap(function _callee54$(_context54) {
          while (1) {
            switch (_context54.prev = _context54.next) {
              case 0:
                libraryId = _ref61.libraryId, objectId = _ref61.objectId, versionHash = _ref61.versionHash, partHash = _ref61.partHash;
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee56(_ref62) {
        var libraryId, objectId, versionHash, partHash, _ref62$format, format, _ref62$chunked, chunked, _ref62$chunkSize, chunkSize, callback, encrypted, encryption, path, headers, conk, response, data, bytesTotal, bytesFinished, stream, totalChunks, i, _response;

        return regeneratorRuntime.wrap(function _callee56$(_context56) {
          while (1) {
            switch (_context56.prev = _context56.next) {
              case 0:
                libraryId = _ref62.libraryId, objectId = _ref62.objectId, versionHash = _ref62.versionHash, partHash = _ref62.partHash, _ref62$format = _ref62.format, format = _ref62$format === void 0 ? "arrayBuffer" : _ref62$format, _ref62$chunked = _ref62.chunked, chunked = _ref62$chunked === void 0 ? false : _ref62$chunked, _ref62$chunkSize = _ref62.chunkSize, chunkSize = _ref62$chunkSize === void 0 ? 10000000 : _ref62$chunkSize, callback = _ref62.callback;
        ...
        return regeneratorRuntime.wrap(function _callee57$(_context57) {
          while (1) {
            switch (_context57.prev = _context57.next) {
              case 0:
                libraryId = _ref64.libraryId, objectId = _ref64.objectId, writeToken = _ref64.writeToken;
                _context57.next = 3;
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee64(_ref71) {
        var libraryId, name, description, _ref71$metadata, metadata, fileInfo, access, _ref71$filePaths, filePaths, _ref71$copy, copy, callback, contentType, _ref72, id, write_token, accessParameter, region, bucket, accessKey, secret, _ref73, logs, errors, warnings, finalizeResponse;

        return regeneratorRuntime.wrap(function _callee64$(_context64) {
          while (1) {
            switch (_context64.prev = _context64.next) {
              case 0:
                libraryId = _ref71.libraryId, name = _ref71.name, description = _ref71.description, _ref71$metadata = _ref71.metadata, metadata = _ref71$metadata === void 0 ? {} : _ref71$metadata, fileInfo = _ref71.fileInfo, access = _ref71.access, _ref71$filePaths = _ref71.filePaths, filePaths = _ref71$filePaths === void 0 ? [] : _ref71$filePaths, _ref71$copy = _ref71.copy, copy = _ref71$copy === void 0 ? false : _ref71$copy, callback = _ref71.callback;
                _context64.next = 3;
                return this.ContentType({
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee65(_ref74) {
        var libraryId, name, description, _ref74$metadata, metadata, masterVersionHash, abrProfile, _ref74$variant, variant, abrMezType, _ref75, id, write_token, masterName, authorizationTokens, headers, body, _ref76, logs, errors, warnings, finalizeResponse;

        return regeneratorRuntime.wrap(function _callee65$(_context65) {
          while (1) {
            switch (_context65.prev = _context65.next) {
              case 0:
                libraryId = _ref74.libraryId, name = _ref74.name, description = _ref74.description, _ref74$metadata = _ref74.metadata, metadata = _ref74$metadata === void 0 ? {} : _ref74$metadata, masterVersionHash = _ref74.masterVersionHash, abrProfile = _ref74.abrProfile, _ref74$variant = _ref74.variant, variant = _ref74$variant === void 0 ? "default" : _ref74$variant;
                _context65.next = 3;
                return this.ContentType({
                  name: "ABR Master"
                });
              ...
              case 10:
                _ref75 = _context65.sent;
                id = _ref75.id;
                write_token = _ref75.write_token;
                _context65.next = 15;
                return this.ContentObjectMetadata({
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee67(_ref77) {
        ...
        var libraryId, objectId, _ref77$offeringKey, offeringKey, _ref77$access, access, mezzanineMetadata, prepSpecs, masterVersionHashes, authorizationTokens, headers, accessParameter, region, bucket, accessKey, secret, _ref79, write_token, _ref80, data, errors, warnings, logs;

        return regeneratorRuntime.wrap(function _callee67$(_context67) {
          while (1) {
            switch (_context67.prev = _context67.next) {
              case 0:
                libraryId = _ref77.libraryId, objectId = _ref77.objectId, _ref77$offeringKey = _ref77.offeringKey, offeringKey = _ref77$offeringKey === void 0 ? "default" : _ref77$offeringKey, _ref77$access = _ref77.access, access = _ref77$access === void 0 ? {} : _ref77$access;
                _context67.next = 3;
                return this.ContentObjectMetadata({
                  libraryId: libraryId,
                  objectId: objectId,
              ...
              case 18:
                _ref79 = _context67.sent;
                write_token = _ref79.write_token;
                _context67.next = 22;
                return this.CallBitcodeMethod({
                  libraryId: libraryId,
                  objectId: objectId,
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee68(_ref81) {
        var libraryId, objectId, writeToken, _ref81$offeringKey, offeringKey, mezzanineMetadata, masterHash, authorizationTokens, headers, _ref82, data, errors, warnings, logs, finalizeResponse;

        return regeneratorRuntime.wrap(function _callee68$(_context68) {
          while (1) {
            switch (_context68.prev = _context68.next) {
              case 0:
                libraryId = _ref81.libraryId, objectId = _ref81.objectId, writeToken = _ref81.writeToken, _ref81$offeringKey = _ref81.offeringKey, offeringKey = _ref81$offeringKey === void 0 ? "default" : _ref81$offeringKey;
                _context68.next = 3;
                return this.ContentObjectMetadata({
                  libraryId: libraryId,
                  objectId: objectId,
        ...
        return regeneratorRuntime.wrap(function _callee69$(_context69) {
          while (1) {
            switch (_context69.prev = _context69.next) {
              case 0:
                objectId = _ref83.objectId, accessCharge = _ref83.accessCharge;
        ...
        return regeneratorRuntime.wrap(function _callee71$(_context71) {
          while (1) {
            switch (_context71.prev = _context71.next) {
              case 0:
                objectId = _ref85.objectId, args = _ref85.args;
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee72(_ref86) {
        var libraryId, objectId, versionHash, _ref86$args, args, _ref86$update, update, _ref86$noCache, noCache;

        return regeneratorRuntime.wrap(function _callee72$(_context72) {
          while (1) {
            switch (_context72.prev = _context72.next) {
              case 0:
                libraryId = _ref86.libraryId, objectId = _ref86.objectId, versionHash = _ref86.versionHash, _ref86$args = _ref86.args, args = _ref86$args === void 0 ? [] : _ref86$args, _ref86$update = _ref86.update, update = _ref86$update === void 0 ? false : _ref86$update, _ref86$noCache = _ref86.noCache, noCache = _ref86$noCache === void 0 ? false : _ref86$noCache;
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee74(_ref88) {
        var objectId, versionHash, _ref88$noCache, noCache, libraryId, audienceData;

        return regeneratorRuntime.wrap(function _callee74$(_context74) {
          while (1) {
            switch (_context74.prev = _context74.next) {
              case 0:
                objectId = _ref88.objectId, versionHash = _ref88.versionHash, _ref88$noCache = _ref88.noCache, noCache = _ref88$noCache === void 0 ? false : _ref88$noCache;
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee75$(_context75) {
          while (1) {
            switch (_context75.prev = _context75.next) {
              case 0:
                objectId = _ref89.objectId, versionHash = _ref89.versionHash, percentComplete = _ref89.percentComplete;
      ...
      function FinalizeStateChannelAccess(_x73) {
    ...
    value: function () {
      ...
      function ContentObjectAccessComplete(_x74) {
          ...
          while (1) {
            switch (_context77.prev = _context77.next) {
              case 0:
                ...
                return _context77.abrupt("return", availableDRMs);
          ...
          while (1) {
            switch (_context78.prev = _context78.next) {
              ...
              case 11:
                ...
                _context78.t0 = Object;
                _context78.t1 = ResponseToJson;
              ...
              case 18:
                ...
                _context78.next = 24;
                return (0, _context78.t1)(_context78.t6);

              case 24:
                _context78.t7 = _context78.sent;
                playoutOptions = _context78.t0.values.call(_context78.t0, _context78.t7);
                playoutMap = {};
                i = 0;
              ...
              case 28:
                ...
                return _context78.abrupt("continue", 43);
              ...
              case 40:
                _context78.t8 = _context78.sent;
                playoutMap[protocol] = {
                  playoutUrl: _context78.t8
                };
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee79$(_context79) {
          while (1) {
            switch (_context79.prev = _context79.next) {
              ...
              case 4:
                playoutOptions = _context79.sent;
                config = {
                  drm: {}
                };
                ...
                return _context79.abrupt("return", config);
      ...
      function BitmovinPlayoutOptions(_x76) {
    ...
    value: function () {
      ...
      function CallBitcodeMethod(_x77) {
          ...
          while (1) {
            switch (_context82.prev = _context82.next) {
              case 0:
                ...
                return _context82.abrupt("return", this.FabricUrl({
                  libraryId: libraryId,
                  objectId: objectId,
                  versionHash: versionHash,
                  publicRep: rep,
        ...
        return regeneratorRuntime.wrap(function _callee84$(_context84) {
          while (1) {
            switch (_context84.prev = _context84.next) {
              ...
              case 5:
                authorizationToken = _context84.sent;
                return _context84.abrupt("return", this.HttpClient.URL({
                  path: path,
                  queryParams: _objectSpread({}, queryParams, {
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee85(_ref99) {
        var name, description, _ref99$metadata, metadata, _ref100, contractAddress, objectId, editResponse;

        return regeneratorRuntime.wrap(function _callee85$(_context85) {
          while (1) {
            switch (_context85.prev = _context85.next) {
              case 0:
                name = _ref99.name, description = _ref99.description, _ref99$metadata = _ref99.metadata, metadata = _ref99$metadata === void 0 ? {} : _ref99$metadata;
                this.Log("Creating access group: ".concat(name || "", " ").concat(description || ""));
                _context85.next = 4;
                return this.authClient.CreateAccessGroup();

              case 4:
                _ref100 = _context85.sent;
      ...
      function CreateAccessGroup(_x82) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee86(_ref101) {
        var contractAddress;
      ...
      function AccessGroupOwner(_x83) {
    ...
    value: function () {
      ...
      function DeleteAccessGroup(_x84) {
    ...
    value: function () {
      ...
      function AccessGroupMembers(_x85) {
    ...
    value: function () {
            ...
            switch (_context91.prev = _context91.next) {
              ...
              case 4:
                ...
                function () {
                  ...
                  /*#__PURE__*/
                  regeneratorRuntime.mark(function _callee90(_, i) {
                    return regeneratorRuntime.wrap(function _callee90$(_context90) {
                      while (1) {
                        switch (_context90.prev = _context90.next) {
                          case 0:
                            _context90.t0 = _this8.utils;
                            _context90.next = 3;
                          ...
                          case 3:
                            ...
                            return _context90.abrupt("return", _context90.t0.FormatAddress.call(_context90.t0, _context90.t1));
      ...
      function AccessGroupManagers(_x88) {
    ...
    value: function () {
      ...
      function AccessGroupMembershipMethod(_x91) {
    ...
    value: function () {
      ...
      function AddAccessGroupMember(_x92) {
    ...
    value: function () {
      ...
      function RemoveAccessGroupMember(_x93) {
    ...
    value: function () {
      ...
      function AddAccessGroupManager(_x94) {
    ...
    value: function () {
      ...
      function RemoveAccessGroupManager(_x95) {
            ...
            switch (_context99.prev = _context99.next) {
              case 0:
                ...
                function () {
                  ...
                  /*#__PURE__*/
                  regeneratorRuntime.mark(function _callee98(type) {
                        ...
                        switch (_context98.prev = _context98.next) {
                          ...
                          case 2:
                            ...
                            function () {
                              ...
                              /*#__PURE__*/
                              regeneratorRuntime.mark(function _callee97(i) {
                                return regeneratorRuntime.wrap(function _callee97$(_context97) {
                                  while (1) {
                                    switch (_context97.prev = _context97.next) {
                                      case 0:
                                        _context97.prev = 0;
                                        _context97.t0 = _this9.utils;
                                        _context97.next = 4;
                                        return _this9.CallContractMethod({
                                          contractAddress: _this9.utils.HashToAddress(libraryId),
                                          abi: LibraryContract.abi,
                                      ...
                                      case 8:
                                        _context97.prev = 8;
                                        _context97.t2 = _context97["catch"](0);
                                        // eslint-disable-next-line no-console
                                        console.error(_context97.t2);
                          ...
                          case 6:
                            accessGroupAddresses = _context98.sent;
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee100$(_context100) {
          while (1) {
            switch (_context100.prev = _context100.next) {
              case 0:
                libraryId = _ref115.libraryId, groupAddress = _ref115.groupAddress, permission = _ref115.permission;
      ...
      function AddContentLibraryGroup(_x99) {
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee101$(_context101) {
          while (1) {
            switch (_context101.prev = _context101.next) {
              case 0:
                libraryId = _ref116.libraryId, groupAddress = _ref116.groupAddress, permission = _ref116.permission;
      ...
      function RemoveContentLibraryGroup(_x100) {
        ...
        return regeneratorRuntime.wrap(function _callee102$(_context102) {
          while (1) {
            switch (_context102.prev = _context102.next) {
              ...
              case 10:
                _context102.t0 = undefined;

              case 11:
                walletAddress = _context102.t0;
    ...
    value: function () {
      ...
      function VerifyContentObject(_x102) {
          ...
          while (1) {
            switch (_context104.prev = _context104.next) {
              case 0:
                ...
                _context104.t0 = ResponseToJson;
                _context104.t1 = this.HttpClient;
                _context104.next = 7;
                return this.authClient.AuthorizationHeader({
                  libraryId: libraryId,
                  objectId: objectId,
              ...
              case 7:
                ...
                _context104.t5 = _context104.t1.Request.call(_context104.t1, _context104.t4);
                return _context104.abrupt("return", (0, _context104.t0)(_context104.t5));
          ...
          while (1) {
            switch (_context105.prev = _context105.next) {
              case 0:
                ...
                _context105.t0 = ResponseToFormat;
                _context105.t1 = format;
                _context105.t2 = this.HttpClient;
                _context105.next = 7;
                return this.authClient.AuthorizationHeader({
                  libraryId: libraryId,
                  objectId: objectId,
              ...
              case 7:
                ...
                _context105.t6 = _context105.t2.Request.call(_context105.t2, _context105.t5);
                return _context105.abrupt("return", (0, _context105.t0)(_context105.t1, _context105.t6));
    ...
    value: function () {
      ...
      function CallContractMethod(_x107) {
    ...
    value: function () {
      ...
      function CallContractMethodAndWait(_x108) {
    ...
    value: function () {
      ...
      function SetCustomContentContract(_x109) {
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee111$(_context111) {
          while (1) {
            switch (_context111.prev = _context111.next) {
              case 0:
                libraryId = _ref129.libraryId, objectId = _ref129.objectId;
      ...
      function CustomContractAddress(_x110) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee112(_ref130) {
        ...
        return regeneratorRuntime.wrap(function _callee115$(_context115) {
          while (1) {
            switch (_context115.prev = _context115.next) {
              case 0:
                _ref133 = _args115.length > 0 && _args115[0] !== undefined ? _args115[0] : {}, toBlock = _ref133.toBlock, fromBlock = _ref133.fromBlock, _ref133$count = _ref133.count, count = _ref133$count === void 0 ? 10 : _ref133$count, _ref133$includeTransa = _ref133.includeTransaction, includeTransaction = _ref133$includeTransa === void 0 ? false : _ref133$includeTransa;
                _context115.next = 3;
                return this.FormatBlockNumbers({
                  fromBlock: fromBlock,
                  toBlock: toBlock,
          ...
          while (1) {
            switch (_context119.prev = _context119.next) {
              ...
              case 2:
                if (message.callbackId) {
                  callback = function callback(result) {
                    Respond(_this10.utils.MakeClonable({
              ...
              case 21:
                ...
                // eslint-disable-next-line no-console
                this.Log("Frame Message Error:\n        Method: ".concat(message.calledMethod, "\n        Arguments: ").concat(JSON.stringify(message.args, null, 2), "\n        Error: ").concat(_typeof(_context119.t0) === "object" ? JSON.stringify(_context119.t0, null, 2) : _context119.t0), true); // eslint-disable-next-line no-console
