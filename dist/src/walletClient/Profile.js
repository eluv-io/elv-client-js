...
exports.ProfileMetadata = function _callee(_ref3) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return _regeneratorRuntime.awrap(this.stateStoreClient.Request({
        ...
        case 7:
          _context.next = 9;
          return _regeneratorRuntime.awrap(Utils.ResponseToJson(response));
...
exports.SetProfileMetadata = function _callee2(_ref4) {
  var _ref4$type, type, _ref4$mode, mode, appId, key, value;

  return _regeneratorRuntime.async(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _ref4$type = _ref4.type, type = _ref4$type === void 0 ? "app" : _ref4$type, _ref4$mode = _ref4.mode, mode = _ref4$mode === void 0 ? "public" : _ref4$mode, appId = _ref4.appId, key = _ref4.key, value = _ref4.value;
          _context2.next = 3;
          return _regeneratorRuntime.awrap(this.stateStoreClient.Request({
            method: "POST",
            path: UserProfilePath({
...
exports.RemoveProfileMetadata = function _callee3(_ref5) {
...
exports.Profile = function _callee4(_ref6) {
  var userAddress, userName, imageUrl;
  return _regeneratorRuntime.async(function _callee4$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          userAddress = _ref6.userAddress, userName = _ref6.userName;
          ...
          _context4.next = 4;
          return _regeneratorRuntime.awrap(this.UserNameToAddress({
            userName: userName
          }));
        ...
        case 7:
          ...
          _context4.next = 10;
          return _regeneratorRuntime.awrap(this.ProfileMetadata({
            type: "user",
...
exports.UserNameToAddress = function _callee5(_ref7) {
