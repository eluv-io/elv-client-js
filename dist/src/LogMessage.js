...
var LogMessage = function LogMessage(reporter, message) {
  ...
  error ? customError ? customError(prefix, message) : // eslint-disable-next-line no-console
  console.error(standardMsg) : customLog ? customLog(prefix, message) : // eslint-disable-next-line no-console
